            ...
            <div className="w-full xl:w-2/3">
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                    ...
                    <div className="bg-sky py-6 px-4 rounded-md flex-1 flex gap-4">
                        <div className="w-1/3">
                            <Image src="https://images.pexels.com/photos/28607266/pexels-photo-28607266/free-photo-of-young-man-in-leather-jacket-with-urban-motion-blur.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                                alt=""
                                width={144}
                                height={144}
                    ...
                    <div className="flex-1 flex gap-4 justify-between flex-wrap">
                        ...
                        <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:[48%]">
                            ...
                            <div className="">
                                <h1 className="text-xl font-semibold">6/1</h1>
